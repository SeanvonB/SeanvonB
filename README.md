...
I'm Sean, and I'm a Software Developer in the Seattle area. My eventual goal is to become the Full**est** Stack Developer: one who will unite all of the technologies, from the silicon up to UI/UX, and bring balance to the Stack; but, in the meantime, I mostly create fun JavaScript toys, dabble in machine learning with Python, and build PCs.
...
class About extends Me {
	constructor(...args) {
		...
		this.communities = ["Exercism", "The Odin Project", "Udacity"];
...
I've been working on a self-hosted deployment of [FoundryVTT](https://foundryvtt.com/) on a Linux VM from DigitalOcean. It started with a [tutorial by Ben Price](https://benprice.dev/posts/fvtt-docker-tutorial/) that uses Portainer for managing Docker and Traeffik for networking and encryption. I haven't pushed a repo and most of the project is secured behind a login, but you can still view my custom landing page!
